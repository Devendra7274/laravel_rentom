<ul class="navbar-nav iq-main-menu"  id="sidebar">
   ...
   <!-- <li class="nav-item">
        <a class="nav-link" aria-current="page" href="{{route('rooms.index')}}" >
            <i class="icon">
                 <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="sidebar-special-pages" data-bs-parent="#sidebar">
            <li class=" nav-item">
                <a class="nav-link {{activeRoute(route('rooms.index'))}}" href="{{route('rooms.index')}}">
                  <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class="nav-item">
                <a class="nav-link  {{activeRoute(route('room_users.addroomuser'))}}" href="{{route('room_users.addroomuser')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <span class="item-name">Add Room User</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('room_users.viewUser'))}}" href="{{route('room_users.viewUser')}}">
                   <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                   ...
                   <span class="item-name">All Room Users</span>
                </a>
            </li>
        </ul>
    </li>
<!-- 
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{route('room_rent.index')}}" >
            <i class="icon">
                 <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="item-name">Manage Room Rent</span>
        </a>
    </li>
    <!-- 
    <li class="nav-item">
